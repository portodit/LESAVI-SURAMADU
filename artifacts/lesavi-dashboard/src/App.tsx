...
window.extractDateFromFilename = function(source: string): { display: string; isoDate: string; period: string } | null {
  ...
  if (match1) {
    ...
    return { isoDate: `${year}-${month}-${day}`, period: `${year}-${month}`, display: `${day}/${month}/${year}` };
  }
