            ...
            {(()=>{
              ...
              return(<>
                ...
                <td className="px-4 py-3 text-right whitespace-nowrap" style={stickyCell}>
                  {cr!==null?(<div className="relative inline-block group"><span className={cn("font-bold text-sm tabular-nums cursor-help underline decoration-dotted decoration-1 underline-offset-2",cr>=0.7?"text-emerald-600":"text-red-600")}>{(cr*100).toFixed(1)}%</span><div className="absolute right-0 bottom-full mb-2 z-[60] opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150" style={{minWidth:"220px"}}><div className="bg-popover border border-border rounded-lg shadow-xl p-3 text-left"><div className="text-[10px] font-black text-muted-foreground uppercase tracking-wide mb-2">Perhitungan Conv. Rate</div><div className="space-y-1.5"><div className="flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">F5 (Closed/Won)</span><span className="text-xs font-bold text-foreground tabular-nums whitespace-nowrap">{formatRupiahFull(f5Val)}</span></div><div className="flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">F3 + F4 + F5</span><span className="text-xs font-bold text-foreground tabular-nums whitespace-nowrap">{formatRupiahFull(f345Val)}</span></div><div className="border-t border-border pt-1.5 flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">CR = F5 ÷ (F3+F4+F5)</span><span className={cn("text-xs font-black tabular-nums whitespace-nowrap",cr>=0.7?"text-emerald-600":"text-red-600")}>= {(cr*100).toFixed(1)}%</span></div></div></div></div></div>):<span className="text-muted-foreground text-xs">—</span>}
                </td>
              </>);
            })()}
          </tr>
                ...
                {phaseExpanded&&(
                  <>
                    ...
                    <tr className="bg-red-50 border-t border-red-200" style={ringStyle({})}>
                      ...
                      <td className="px-4 py-2 text-left tabular-nums font-black text-red-800 whitespace-nowrap text-base">{formatRupiahFull(phaseTotal)}</td>
                    </tr>
                  </>
                )}
              </React.Fragment>
        ...
        <table key={amKey} className="text-left text-sm" style={FS_TB_STYLE}><FSColGroup/>
          <tbody>
            <tr className="cursor-pointer select-none bg-card hover:bg-secondary/30 transition-colors" style={{borderTop:"2px solid transparent"}} onClick={()=>toggleAmRow(amKey)}>
              ...
              <td className="px-3 py-3">{amTgt>0?<span className="text-sm font-black tabular-nums text-foreground">{formatRupiahFull(amTgt)}</span>:<span className="text-muted-foreground text-xs">—</span>}</td>
              ...
              <td className="px-4 py-3 text-right whitespace-nowrap">{crAm!==null?(<div className="relative inline-block group"><span className={cn("font-bold text-sm tabular-nums cursor-help underline decoration-dotted decoration-1 underline-offset-2",crAm>=0.7?"text-emerald-600":"text-red-600")}>{(crAm*100).toFixed(1)}%</span><div className="absolute right-0 bottom-full mb-2 z-[60] opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150" style={{minWidth:"220px"}}><div className="bg-popover border border-border rounded-lg shadow-xl p-3 text-left"><div className="text-[10px] font-black text-muted-foreground uppercase tracking-wide mb-2">Perhitungan Conv. Rate</div><div className="space-y-1.5"><div className="flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">F5 (Closed/Won)</span><span className="text-xs font-bold text-foreground tabular-nums whitespace-nowrap">{formatRupiahFull(f5Val)}</span></div><div className="flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">F3 + F4 + F5</span><span className="text-xs font-bold text-foreground tabular-nums whitespace-nowrap">{formatRupiahFull(f345Val)}</span></div><div className="border-t border-border pt-1.5 flex items-center justify-between gap-4"><span className="text-xs text-muted-foreground whitespace-nowrap">CR = F5 ÷ (F3+F4+F5)</span><span className={cn("text-xs font-black tabular-nums whitespace-nowrap",crAm>=0.7?"text-emerald-600":"text-red-600")}>= {(crAm*100).toFixed(1)}%</span></div></div></div></div></div>):<span className="text-muted-foreground text-xs">—</span>}</td>
            </tr>
          </tbody>
        </table>
      );}
        ...
        <table ref={fsFunnelAmTableCallbackRef} className="text-left text-sm" style={{...FS_TB_STYLE,position:"sticky",top:fsFunnelTheadH,zIndex:16,boxShadow:"0 2px 8px rgba(0,0,0,0.13)"}}><FSColGroup/>
          <tbody>
            <tr className="cursor-pointer select-none hover:brightness-95 transition-colors"
              ...
              <td className="px-3 py-2.5" style={bg}>{amTgt>0?<span className="text-sm font-black tabular-nums text-foreground">{formatRupiahFull(amTgt)}</span>:<span className="text-muted-foreground text-xs">—</span>}</td>
              ...
              <thead style={multiExpanded ? undefined : {position:"sticky",top:fsFunnelTheadH+fsFunnelAmRowH,zIndex:15}}>
                ...
                {phaseExpanded&&(
                  <tr className="bg-slate-100 border-y border-slate-300" style={{borderLeft:`2px solid ${ring}`,borderRight:`2px solid ${ring}`}}>
                    <th className="px-4 py-2 pl-16 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">Nama Proyek</th>
                    <th className="px-3 py-2 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">Kategori</th>
                    <th className="px-3 py-2 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">Durasi</th>
                    <th className="px-3 py-2 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">LOP ID</th>
                    <th className="px-3 py-2 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">Pelanggan</th>
                    <th className="px-4 py-2 text-xs font-black text-slate-800 uppercase tracking-wider font-normal text-left">Nilai</th>
                  </tr>
                )}
              </thead>
            ...
            <table ref={fsFunnelTheadRef} className="text-left text-sm" style={{...FS_TB_STYLE,position:"sticky",top:0,zIndex:20}}>
              ...
              <thead>
                <tr className="text-white font-black uppercase tracking-wide text-xs">
                  ...
                  <th className="px-3 py-3 text-left whitespace-nowrap" style={{background:"#B91C1C"}}>Target 2026</th>
                  ...
                  <table className="w-full text-left text-sm border-collapse" style={{minWidth:"600px"}}>
                    <thead>
                      <tr className={`${headerBg} text-white font-black uppercase tracking-wide text-xs`}>
                        ...
                        <th className="px-3 py-2.5 whitespace-nowrap text-left">Target 2026</th>
